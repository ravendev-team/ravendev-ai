! This is module for freeglut for Windows
! (c) Mykola Yas'ko  It's free!
module OpenGL
USE, INTRINSIC :: ISO_C_BINDING, only : C_INTPTR_T, C_FUNPTR, C_PTR
...
character(100),pointer :: glGetString
...
interface
integer(C_INTPTR_T) function gluNewQuadric() bind(C,name='gluNewQuadric')
import
...
interface
integer(C_INTPTR_T) function gluNewTess() bind(C,name='gluNewTess')
 import
...
interface
integer(C_INTPTR_T) function gluNewNurbsRenderer() bind(C,name='gluNewNurbsRenderer')
import
...
integer(4),parameter,public :: GLUT_STROKE_ROMAN=0
integer(4),parameter,public :: GLUT_STROKE_MONO_ROMAN=1
integer(4),parameter,public :: GLUT_BITMAP_9_BY_15=2
integer(4),parameter,public :: GLUT_BITMAP_8_BY_13=3
integer(4),parameter,public :: GLUT_BITMAP_TIMES_ROMAN_10=4
integer(4),parameter,public :: GLUT_BITMAP_TIMES_ROMAN_24=5
integer(4),parameter,public :: GLUT_BITMAP_HELVETICA_10=6
integer(4),parameter,public :: GLUT_BITMAP_HELVETICA_12=7
integer(4),parameter,public :: GLUT_BITMAP_HELVETICA_18=8

integer(4),parameter,public :: GLUT_ACTION_EXIT=0
integer(4),parameter,public :: GLUT_ACTION_GLUTMAINLOOP_RETURNS=1
integer(4),parameter,public :: GLUT_ACTION_CONTINUE_EXECUTION=2
 ...
 integer(4) function glutCreateMenu(fun) bind(C,name='glutCreateMenu')
  interface
   subroutine fun(val) bind(C)
    import
    integer(GLint), intent(in), value :: val
   end subroutine fun
  end interface
...
interface
 subroutine glutAddMenuEntry(char,value) bind(C,name='glutAddMenuEntry')
...
interface
 subroutine glutAddSubMenu(char,submenu) bind(C,name='glutAddSubMenu')
  character(*), intent(in) :: char
...
interface
 subroutine glutBitmapCharacter(font,character) bind(C,name='glutBitmapCharacter')
  integer(4),intent(in), value :: font
...
interface
TYPE(C_FUNPTR) function glutGetProcAddress(procName) BIND(C,NAME="glutGetProcAddress")
IMPORT
...
interface
 subroutine g_glutSetFCB(n,func) bind(C,name='__glutSetFCB@8')
  integer(4),intent(in), value :: n
  external func
